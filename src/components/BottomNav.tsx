...
export function BottomNav({ onOpenModal }: { onOpenModal?: () => void }) {
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-50 w-[92%] md:w-1/2 lg:w-[40%] max-w-2xl">
      <div className="bg-white/85 backdrop-blur-xl border border-white/40 shadow-[0_8px_32px_rgba(0,0,0,0.12)] rounded-full p-1.5 flex items-center justify-around">
        <Link 
          to={getHomePath()} 
