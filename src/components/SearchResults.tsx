              ...
              {paginatedClinics.length === 0 ? (
                ...
                <>
                  {paginatedClinics.map(clinic => (
                    <div 
                      key={clinic.id} 
                      className="bg-white rounded-2xl overflow-hidden border border-gray-200 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg flex flex-col sm:flex-row relative group"
                    >
                      <Link 
                        to={`/${lang === 'en' ? '' : lang + '/'}chatmt/${clinic.slug}`}
                        className="absolute inset-0 z-0"
                      />
                      <div className="w-full sm:w-[240px] h-[200px] sm:h-auto relative shrink-0">
                      ...
                      <div className="p-5 flex-1 flex flex-col justify-between relative z-10 pointer-events-none">
                        <div>
                          ...
                          <div className="text-[1.15rem] font-semibold text-navy mb-2">{clinic.name}</div>
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-gray-100 mt-4 pointer-events-auto">
                          <div>
                          ...
                          <Link 
                            ...
                            className="font-sans text-[0.82rem] font-semibold text-blue bg-light-blue border-none rounded-full px-5 py-2 cursor-pointer transition-colors hover:bg-blue hover:text-white relative z-10"
                          >
